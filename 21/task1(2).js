...
const ModifyConditionCapitalize = arr => arr.map(item => item.charAt(0).toUpperCase() + item.slice(1).toLowerCase());
const ModifyLowerCase = arr => arr.map(item => item.toLowerCase());
